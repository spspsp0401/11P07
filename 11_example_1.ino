...
int _DUTY_NEU  = 1500; // servo neutral position (90 degree)
...
void loop() {
  ...
  int servo_angle = map(dist_ema, _TARGET_LOW, _TARGET_HIGH, 0, 180);
  servo_angle = constrain(servo_angle, 0, 180);
  // add your code here!
  _DUTY_NEU = ((_DUTY_MAX - _DUTY_MIN)/(_TARGET_HIGH - _TARGET_LOW))*(dist_raw-_TARGET_LOW)+_DUTY_MIN;
